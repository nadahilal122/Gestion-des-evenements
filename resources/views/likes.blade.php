...
<div class="containers">
    ...
    <ul class="responsive-table">
        ...
        <li class="table-row">
            ...
            <div class="col col-3" data-label="Likes">{{ $Like->likes }}</div>
