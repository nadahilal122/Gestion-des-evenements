...
<div class="row">
        <div class="col-lg-4">
           <div class="profile-card-4 z-depth-3">
            <div class="card">
              ...
              <div class="user-box">
              <img src="{{ asset('storage/' . $client->photo) }}"  class="img-profile rounded-circle img-fluid" width="200" height="100">
                    </div>
              <h5 class="mb-1 text-white"></h5>
              <h6 class="text-light">{{$client->username}}</h6>
             </div>
              <div class="card-body">
    ...
    <li class="nav-item">
        <a  data-toggle="pill" class="nav-link active show"><i class="icon-user"></i> <span class="hidden-xs">Edit</span></a>
    </li>
...
@csrf
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Number</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="phoneNumber"  name="number" value="{{$client->number}}">
                            </div>
                        </div><br>
